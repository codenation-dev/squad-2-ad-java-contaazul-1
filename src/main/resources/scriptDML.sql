...
delete  from LEVEL;
delete  from ROLE;
delete  from TBUser_ROLES;

-- Inicializando as Sequences 

ALTER SEQUENCE environment_id_seq RESTART WITH 1;
ALTER SEQUENCE level_id_seq RESTART WITH 1;
ALTER SEQUENCE log_log_id_seq RESTART WITH 1;
ALTER SEQUENCE tbuser_user_id_seq RESTART WITH 1;
ALTER SEQUENCE hibernate_sequence RESTART WITH 1;
-- falta RESETAR a sequence da tabela roles
...
INSERT INTO LEVEL(name) VALUES('waring');
